function agentMesh(size, colorName = 'red') {
  ...
  //  const points = [];
  //  points.push(new THREE.Vector3(3 * size, 0, 0)) //a
  //  points.push(new THREE.Vector3(0, 0, -size)) //b
  //  points.push(new THREE.Vector3(0, 0, size)) //c
  //  points.push(new THREE.Vector3(0, size, 0)) //d
